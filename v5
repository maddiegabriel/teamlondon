...
while ($programFlag == 0) {
    while ($mainFlag == 0) {
        ...
        print "\nQuestion Set 2: What location had the highest/lowest percent change of a violation between two years?\n";
        print "\nQuestion Set 3: Give me the top n locations with the highest/lowest rate of a violation in a year.\n";
        print "\nQuestion Set 4: Give me the top n locations with the highest/lowest percent change of a violation between two years.\n";
        print "\nQuestion Set 5: Give me the line graph for the percent change of a violation in a specific location between 2 years.\n   >> PRESS 9 TO EXIT.\n";
       ...
       #
           ...
           print "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ RESULT ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n";
           if($high_low == 1) {
               print("\nThe top $n (provinces/cities) with the highest rates of $violation_name in $year are:\n");
               for($i = 1; $i <= $n; $i++) {
                   print("\n$i. (location i): (value i) per 100,000 population.");
               }
           } else {
               print("\nThe bottom $n (provinces/cities) with the lowest rates of $violation_name in $year are:\n");
               for($i = 1; $i <= $n; $i++) {
                   print("\n$i. (location i): (value i) per 100,000 population.");
               }
           }
           ...
           print "\nFILL IN THE BLANKS:\nWhat (provinces/cities) had the (top/bottom) (n) percent change of (violation) from (start year) to (end year)?\n";
           while ($flag == 0) {
               print "\nProvince or city? (1 for province, 2 for city): ";
               $geo = <STDIN>;
               chomp $geo;
           ...
           print "\nFILL IN THE BLANKS: Give me the line graph showing the trend of all violations in (location) between (start year) and (end year).\n";
