...
while ($programFlag == 0) {
    while ($mainFlag == 0) {
        ...
        if ($setQ == 1) {
			...
			@result = question_one($year_q1, $violation_q1, $geo_q1, $high_low_q1);
			#print "RESULT ARRAY:: @result";
            # String split coordinate by period
            # This makes each number of the coordinate an element in the array @split_values
            #@split_values = split(/\,/, );
            
            #print "result_coordinate :: $result_coordinate\n";
            
            #my @split_num = split(/\,/, $result_coordinate);
            
            #print "result[0] :: $result[0]\n";
            #print "result[1] :: $result[1]\n";
            #print "split_num[2] :: $split_num[2]\n";
            
			#my $coordinate = $split_num[0];
		    #my $value = $split_num[1];
            ...
            if($high_low_q1== 1) {
                print("\nThe highest rate of violation #$violation_q1 in $year_q1 was $result[1]. It occured in $location.");
            } else {
                print("\nThe lowest rate of violation #$violation_q1 in $year_q1 was $result[1]. It occured in $location.");
            }
            print "\n~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ SEE YA!  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n";
